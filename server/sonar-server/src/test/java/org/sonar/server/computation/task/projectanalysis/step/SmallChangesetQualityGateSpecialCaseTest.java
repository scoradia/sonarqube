...
public class SmallChangesetQualityGateSpecialCaseTest {
  ...
  @Test
  public void should_change_red_to_yellow_for_small_changesets() throws Exception {
    ...
    assertThat(result.evaluationResult.getLevel()).isSameAs(WARN);
  }
  ...
  @Test
  public void should_not_change_quality_gate_new_lines_is_not_defined() throws Exception {
    QualityGateMeasuresStep.MetricEvaluationResult metricEvaluationResult = generateEvaluationResult(NEW_COVERAGE_KEY, ERROR);
    Component project = generateNewRootProject();
